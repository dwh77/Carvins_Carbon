...
# ggsave("../Figures/FigS9_Chem_by_Date.png", Chem_by_date_SI_fig, height = 8, width = 11, units = "in")
...
# ggsave("../Figures/Fig6_DOM_boxplot.png", DOM_boxplots_MS, height = 6, width = 8, units = "in")
...
##NO3
no3_kw <- make_kruskal_dunn_plot(df = chem_kruskal, response_var = "NO3NO2_ugL", 
                                 response_var_label = expression(paste("NO3 (",mu,"g/L)")))
no3_kw$kruskal

##NH4
nh4_kw <- make_kruskal_dunn_plot(df = chem_kruskal, response_var = "NH4_ugL", 
                                 response_var_label = expression(paste("NH4 (",mu,"g/L)")))
nh4_kw$kruskal

##SRP
srp_kw <- make_kruskal_dunn_plot(df = chem_kruskal, response_var = "SRP_ugL", 
                                 response_var_label = expression(paste("SRP (",mu,"g/L)")))
srp_kw$kruskal

##Chl-a
chla_kw <- make_kruskal_dunn_plot(df = chem_kruskal, response_var = "Chla_ugL", 
                                 response_var_label = expression(paste("chl-a (",mu,"g/L)")))
chla_kw$kruskal
...
# ggsave("../Figures/FigS13_NutChla_boxplot.png", nutrient_chla_boxplots_SI, height = 6, width = 8, units = "in")
