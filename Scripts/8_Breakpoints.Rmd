...
```{r}
## Temp
temp_break <- run_breakpoint_analysis(chem, response_var = "Temp_C",
...
## Cond
SC_break <- run_breakpoint_analysis(chem, response_var = "SpCond_uScm",
                                    fill_var = "Depth_m", fill_var_label = "Depth (m)")
...
## DO
DO_break <- run_breakpoint_analysis(chem, response_var = "DOsat_percent",
                                    fill_var = "Depth_m", fill_var_label = "Depth (m)")
...
## d-excess
Dexcess_break <- run_breakpoint_analysis(chem, response_var = "D_excess",
                                    fill_var = "Depth_m", fill_var_label = "Depth (m)")
