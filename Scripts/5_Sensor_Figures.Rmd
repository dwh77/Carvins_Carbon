...
sensors |> 
  ...
  geom_point()+ #need shape here if not doing site type
...
cond_S1_C1 <- sensors |> 
  ...
  theme_bw()+ theme(legend.position = "right", text = element_text(size = 12),
                    ...
                    panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  labs(x= "Distance from Stream (m)",
       y = "Depth (m)", fill = "Sp.Con\n (uS/cm)")+
  scale_x_continuous(breaks = c(0, 150, 300)) +
  scale_fill_gradient(low = "blue",  high ="red")
  #scale_fill_gradient2(low = "blue",  high ="red", midpoint = 75,  guide = "colourbar")
...
temp_S1_C1 <- sensors |> 
  ...
  scale_x_continuous(breaks = c(0, 150, 300)) +
  scale_fill_gradient(low = "blue",  high ="red")
  #scale_fill_gradient2(low = "blue",  high ="red", midpoint = median(sensors$Temp_C),  guide = "colourbar")
...
ggsave("../Figures/sensors_S1_C1_fig.png", sensors_S1_C1, width = 10.5, height = 8, units = "in")
...
SpCond_fig <- sensors |> 
 ...
 #scale_color_gradient2(low = "blue",  high ="red", breaks = c(25,75,125), midpoint = 75,  guide = "colourbar")
...
Temp_fig <- sensors |> 
  ...
  scale_x_continuous(breaks = c(0, 600, 1200)) +
  scale_color_gradient(low = "blue",  high ="red")
 # scale_color_gradient2(low = "blue",  high ="red", breaks = c(5,15,25),  midpoint = 15,  guide = "colourbar")
...
sensors_S1_P2
#ggsave("../Figures/sensors_S1_P2_SI_fig.png", sensors_S1_P2, width = 10, height = 8, units = "in")
